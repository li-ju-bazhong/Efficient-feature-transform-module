...
class Block(nn.Module):
    def __init__(self,in_filters,out_filters,reps,strides=1,start_with_relu=True,grow_first=True):
        ...
        if grow_first:
            ...
            rep.append(FeatureTransModule(in_filters,out_filters,3,stride=1,padding=1,bias=False))
            rep.append(nn.BatchNorm2d(out_filters))
            filters = out_filters

        for i in range(reps-1):
            rep.append(nn.ReLU(inplace=True))
            rep.append(FeatureTransModule(filters,filters,3,stride=1,padding=1,bias=False))
...
class Xception(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        self.conv3 = FeatureTransModule(1024,1536,3,1,1)
        self.bn3 = nn.BatchNorm2d(1536)
        self.relu3 = nn.ReLU(inplace=True)

        #do relu here
        self.conv4 = FeatureTransModule(1536,2048,3,1,1)
...
def xception_ftm(num_classes=1000, pretrained=None):
    # Args:
    #    pretrained: selectable arguments 'imagenet'
